...
public class BaseItemBlock extends ItemBlock {
	...
	protected void init() {
		BlockItemRegistry.registerItemStack(new ItemStack(this), "tile." + this.getRegistryName().getPath());
	}
	...
	public void addInformation(ItemStack item, @Nullable World player, List<String> list, ITooltipFlag b) {
		...
		if (TooltipUtil.showShiftHint()) {
			...
			if (TooltipUtil.hasTranslation(s) || (hasSubtypes && TooltipUtil.hasTranslation(getBlock().getTranslationKey() + ":i.tip"))) list.add(TooltipUtil.getShiftHint());
			if (TooltipUtil.hasTranslation(s + "A") || (hasSubtypes && TooltipUtil.hasTranslation(getBlock().getTranslationKey() + ":i.tipA"))) list.add(TooltipUtil.getAltHint());
		}
	...
	public String getTranslationKey(ItemStack item) {
		String s = this.getBlock().getTranslationKey();
